...
class LaboratoireEditType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $builder->add('responsableLabo',EntityType::class, array(
            //'by_reference'=>false,
            ...
            'multiple'     => false,
            'expanded'=>false))
    ->add('nomLabo', TextType::class, array("label" => "Nom de l'établissement hébergeur de la ZRR"))
